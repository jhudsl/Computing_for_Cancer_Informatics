...
<img src="02-Computing_Basics_files/figure-html//1B4LwuvgA6aUopOHEAbES1Agjy7Ex2IpVAoUIoBFbsq0_gf6e632d05f_0_193.png" title="Chart showing the ASCII decimal assigned to the numbers 0-9 and the binary number for that ASCII value. For example, a value of 2 is encoded as 050 in ASCII and the binary number eight bit number for 50 is 00110010." alt="Chart showing the ASCII decimal assigned to the numbers 0-9 and the binary number for that ASCII value. For example, a value of 2 is encoded as 050 in ASCII and the binary number eight bit number for 50 is 00110010." width="100%" style="display: block; margin: auto;" />
