...
```{r, fig.align='center', echo = FALSE, fig.alt= "1. Personal vs Shared, 2. Local Shared vs Remote Shared 3. Which Remote Shared Resource?", out.width="100%"}
ottr::include_slide("https://docs.google.com/presentation/d/1B4LwuvgA6aUopOHEAbES1Agjy7Ex2IpVAoUIoBFbsq0/edit#slide=id.g1175806cc27_0_0")
```
...
ottr::include_slide("https://docs.google.com/presentation/d/1B4LwuvgA6aUopOHEAbES1Agjy7Ex2IpVAoUIoBFbsq0/edit#slide=id.g117b5133acc_71_57")
```
...
```{r, fig.align='center', echo = FALSE, fig.alt= "If you plan on collaborating outside of your institute, consider remote shared resources.", out.width="100%"}
ottr::include_slide("https://docs.google.com/presentation/d/1B4LwuvgA6aUopOHEAbES1Agjy7Ex2IpVAoUIoBFbsq0/edit#slide=id.g117b5133acc_71_69")
```
...
```{r, fig.align='center', echo = FALSE, fig.alt= "If you need extra security and privacy protections for your data, be aware of any extra steps required for any shared computing resource! Some remote resources do not support this. If your personal computer can handle your computing tasks, you can also consider using it.", out.width="100%"}
ottr::include_slide("https://docs.google.com/presentation/d/1B4LwuvgA6aUopOHEAbES1Agjy7Ex2IpVAoUIoBFbsq0/edit#slide=id.g117b5133acc_71_79")
```
...
ottr::include_slide("https://docs.google.com/presentation/d/1B4LwuvgA6aUopOHEAbES1Agjy7Ex2IpVAoUIoBFbsq0/edit#slide=id.g117b5133acc_71_94")
```
...
ottr::include_slide("https://docs.google.com/presentation/d/1B4LwuvgA6aUopOHEAbES1Agjy7Ex2IpVAoUIoBFbsq0/edit#slide=id.g117b5133acc_71_107")
```
...
ottr::include_slide("https://docs.google.com/presentation/d/1B4LwuvgA6aUopOHEAbES1Agjy7Ex2IpVAoUIoBFbsq0/edit#slide=id.g117b5133acc_71_114")
```
...
```{r, fig.align='center', echo = FALSE, fig.alt= "If you might work with really large data, make sure local shared resources will be up to the task, if not considered a remote resource that has large computation/storage capacity. Remote options like SciServer, CyVerse, Globus, Overture, and Jetstream can be helpful for using really large data.", out.width="100%"}
ottr::include_slide("https://docs.google.com/presentation/d/1B4LwuvgA6aUopOHEAbES1Agjy7Ex2IpVAoUIoBFbsq0/edit#slide=id.g117b5133acc_71_131")
```
...
ottr::include_slide("https://docs.google.com/presentation/d/1B4LwuvgA6aUopOHEAbES1Agjy7Ex2IpVAoUIoBFbsq0/edit#slide=id.g117b5133acc_71_152")
```
...
ottr::include_slide("https://docs.google.com/presentation/d/1B4LwuvgA6aUopOHEAbES1Agjy7Ex2IpVAoUIoBFbsq0/edit#slide=id.g117b5133acc_71_163")
```
...
ottr::include_slide("https://docs.google.com/presentation/d/1B4LwuvgA6aUopOHEAbES1Agjy7Ex2IpVAoUIoBFbsq0/edit#slide=id.g117b5133acc_71_174")
...
ottr::include_slide("https://docs.google.com/presentation/d/1B4LwuvgA6aUopOHEAbES1Agjy7Ex2IpVAoUIoBFbsq0/edit#slide=id.g117b5133acc_71_185")
```


This decision should be based on the following:

```{r, fig.align='center', echo = FALSE, fig.alt= "1) Does the resource offer the privacy protection needed? 2) Does the resource allow for me to use the data modalities I need? 3) Does the resource already have data that I might want? 4) Does the resource provide extra guidance that might be helpful for my work? 5) Does the resource offer the interface that I would like to work with?", out.width="100%"}

ottr::include_slide("https://docs.google.com/presentation/d/1B4LwuvgA6aUopOHEAbES1Agjy7Ex2IpVAoUIoBFbsq0/edit#slide=id.g1175806cc27_0_27")
```
