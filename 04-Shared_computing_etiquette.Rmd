...
There are 68 Nodes that make up the JHPCE currently and each one has 2-4 CPUs that provide 24-128 cores! As you can see these processors or chips have a lot more cores per each CPU than a typical personal computer.
